...
export function DeleteFAQButton({ faqId, faqQuestion, children }: DeleteFAQButtonProps) {
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="w-full max-w-md rounded-lg bg-white p-6 dark:bg-gray-800">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Delete FAQ</h3>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Are you sure you want to delete the FAQ: <strong>{faqQuestion}</strong>? This action cannot be undone.
            </p>
